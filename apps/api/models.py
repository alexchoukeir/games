...
class Game(Base):
    ...
    reprocess_needed: Mapped[bool] = mapped_column(Boolean, server_default=False, nullable=False)
...
class SyncLog(Base):
    ...
    new_games: Mapped[int] = mapped_column(Integer, server_default="0")
    updated_games: Mapped[int] = mapped_column(Integer, server_default="0")
    queue_total: Mapped[int] = mapped_column(Integer, server_default="0")
